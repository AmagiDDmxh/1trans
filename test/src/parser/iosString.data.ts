...
export const structureData = [
  {
    type: "pair",
    value: {
      key: "Paired hardware wallet",
      value: "Connecting hardware devices",
    },
  },
  {
    type: "pair",
    value: { key: "Paired hardware", value: "Connection Hardware" },
  },
  {
    type: "pair",
    value: {
  ...
  {
    type: "pair",
    value: { key: "Wallet Detail", value: "Account Details" },
  },
  {
    type: "pair",
    value: { key: "Select wallet Type", value: "Select account type" },
  },
  {
    type: "pair",
    value: { key: "Independent wallet", value: "Separate Account" },
  },
  { type: "pair", value: { key: "Independent", value: "Independent" } },
  {
    type: "pair",
    value: {
      key:
        "With the HD logo, derived from the wallet root mnemonic (the mnemonic you copied when you first created your wallet), a mnemonic can create an infinite number of wallets in multiple currencies. It can also be used to recover all derived wallets, save time, effort and security, is the core bitcoin protocol BIP44 implementation",
      value: "With HD marker, based on the main wallet helper derivation.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "A separate wallet with a separate private key generated by a local encryption algorithm. You need to re-copy mnemonics, and everything is not Shared with HD Wallet",
      value:
        "A separate private key is generated by a local encryption algorithm, which requires a re-transcription of the helper word, and everything is not shared with the main wallet.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The private key or mnemonic of the wallet is securely stored in the hardware device. If you need to export a mnemonic for a hardware wallet, go to Myhardware-All Devices to find the device you want to export.",
      value:
        "The wallet's private key or passphrase is already securely stored in the hardware device. If you need to export your hardware device's mnemonic, please go to My ➡️ All Hardware to find the device you want to export.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "All subwallets derived from the ROOT mnemonic of HD wallet can be recovered with the root mnemonic, so there is no need to export mnemonic words for a single wallet. If you want to get the HD purse the root word mnemonic, please go to my assets HD wallet",
      value:
        "Derived from the main wallet booster, you can restore all accounts under it with one click via the main wallet booster. If you want to back up this helper, please go to My → Assets → Master Wallet to do so.",
    },
  },
  {
    type: "pair",
    value: { key: "To delete the wallet", value: "Delete Account" },
  },
  { type: "pair", value: { key: "Hardware wallet", value: "Hardware" } },
  {
    type: "pair",
    value: {
      key:
        "The following Settings apply to the Bitcoin account for the hardware wallet",
      value:
        "The following settings apply to bitcoin accounts for hardware devices",
    },
  },
  { type: "pair", value: { key: "HD wallet", value: "Main Wallet" } },
  {
    type: "pair",
    value: { key: "HD wallet account", value: "Master Wallet Account" },
  },
  {
    type: "pair",
    value: { key: "BTC wallet", value: "Bitcoin Account" },
  },
  { type: "pair", value: { key: "ETH wallet", value: "Ether account" } },
  { type: "pair", value: { key: "HECO wallet", value: "HECO Account" } },
  { type: "pair", value: { key: "BSC wallet", value: "BSC Account" } },
  {
    type: "pair",
    value: {
      key:
        "HD wallets are known as Hierarchical Deterministic wallets in Chinese. It is by far the best and most convenient deterministic wallet",
      value:
        'The same device has at most one main wallet, but can have multiple accounts under it. Its underlying technology is "hierarchical determinism", and this wallet format is advanced, easy to use, convenient, with high future popularity and excellent compatibility.',
    },
  },
  {
    type: "pair",
    value: { key: "What is HD Wallet", value: "What is a master wallet?" },
  },
  { type: "pair", value: { key: "HD", value: "Main Wallet" } },
  {
    type: "pair",
    value: { key: "Scan QR Code", value: "Scan the QR code" },
  },
  { type: "pair", value: { key: "scan.result", value: "Scan Results" } },
  {
    type: "pair",
    value: {
      key: "HD Wallet root mnemonic",
      value: "Main wallet root helper words",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "Once deleted: 1. All HD wallets will be erased. 2. Please make sure that the root mnemonic of HD Wallet has been copied and kept before deletion. You can use it to recover all HD Wallets and retrieve assets.",
      value: `Once erased.
      1. all accounts under the main wallet will be wiped.
      2. Please make sure that you have copied and kept the master wallet's helper before erasing it, and you can use it to recover all accounts under it to get back your assets.`,
    },
  },
  {
    type: "pair",
    value: { key: "Delete HD Wallet", value: "Erase main wallet" },
  },
  { type: "pair", value: { key: "Wipe", value: "Erasure" } },
  {
    type: "pair",
    value: {
      key: "Please enter the name of the wallet",
  ...
  },
  {
    type: "pair",
    value: {
      key: "Wallet deleted successfully",
  ...
  },
  {
    type: "pair",
    value: {
      key: "Please enter the transfer address",
      value: "Please enter your account number",
    },
  },
  {
    type: "pair",
    value: { key: "Add HD Wallet", value: "Create Master Wallet" },
  },
  {
    type: "pair",
    value: {
      key: "Support BTC, ETH and other main chain",
      value: "Support BTC, ETH and other public chains",
    },
  },
  {
    type: "pair",
    value: { key: "Import through mnemonic", value: "By mnemonic words" },
  },
  {
    type: "pair",
    value: { key: "No purse", value: "No available accounts" },
  },
  {
    type: "pair",
    value: { key: "To delete the wallet", value: "Delete Account" },
  },
  {
    ...
    value: {
      key:
        "This action will delete all data for the wallet, please make sure the wallet is backed up before deleting",
      value:
        "This operation will delete all the data of the account, please make sure the account is backed up before deleting",
    },
  },
  {
    type: "pair",
    value: {
      key: "Open your hardware wallet and hold it close to your phone",
      value: "Turn on your hardware device and get close to the phone.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The synchronous server USES the synchronous server to back up and restore multi-signature wallet, and synchronizes unsigned transactions among multiple co-signers; The synchronization server stores only public information such as the wallet public key and name, and does not store any private keys and personal information",
      value:
        "Synchronization Server Using a synchronization server to back up and restore multi-signature accounts and to synchronize unsigned transactions across multiple co-signers. The synchronization server only stores public information such as the public key and name of the account, and does not store any private key or personal information.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Find the following wallet",
      value: "Find the following accounts",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "You have derived the following wallet using the HD mnemonic, select the one you want to recover. If you do not want to recover the wallet for a while, you can skip it and readd it later in the HD Wallet. Your assets will not be lost",
      value:
        "You have used the following accounts derived from the main wallet helper, select the ones you want to restore. The wallets you do not want to restore at the moment you can skip and re-add them later in the main wallet and your assets will not be lost.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Wallet names cannot exceed 15 characters",
      value: "Account name cannot exceed 15 characters",
    },
  },
  {
    type: "pair",
    value: {
      key: "Make a backup of your wallet before deleting it",
      value: "Please backup your account before deleting it",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "This action deletes all data for the wallet. In order to avoid loss of your property, please complete the backup of your wallet first.",
      value:
        "This operation will delete all data on the account. To avoid any loss of your property, please complete a backup first.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Independent wallet mnemonic",
      value: "Separate Account Boosters",
    },
  },
  {
    type: "pair",
    value: {
      key: "Hardware recovery for HD Wallet",
      value: "Hardware recovery of the main wallet",
    },
  },
  { type: "pair", value: { key: "Observation", value: "Observation" } },
  {
    type: "pair",
    value: {
      key: "Delete a separate wallet",
      value: "Delete Separate Accounts",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "Once deleted: 1. The wallet will be erased from the App. 2. Please make sure that the mnemonic of the independent wallet has been copied and kept before deletion. You can use it to recover the wallet, so as to recover the assets.",
      value: `Once deleted.
      1. the account will be wiped from the App.
      2. Please make sure that the account's helper is copied and stored before you delete it, so you can use it to recover it and get your assets back.`,
    },
  },
  {
    type: "pair",
  ...
  },
  {
    type: "pair",
    value: {
      key: "Add a new wallet (recommended)",
      value: "Add an account (recommended)",
    },
  },
  {
    type: "pair",
    value: {
      key: "Up to 20 derived wallets can be created, as needed",
      value: "Support BTC, ETH and other public chains",
    },
  },
  {
    type: "pair",
    value: {
      key: "Restore the wallet that was created from this hardware device",
      value: "Recovering a previously used wallet",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "If you have ever deleted a wallet created by the device on your phone, you can recover it this way.",
      value:
        "If you have ever deleted an account on your phone that was created by that device, you can use this method to recover it.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Create a Condominium wallet (Advanced)",
      value: "Create a Condominium Account (Advanced)",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "Enter your 6-digit password according to the PIN code location comparison table displayed on the device",
      value:
        "Enter your PIN according to the PIN location chart displayed on the device",
    },
  },
  {
    type: "pair",
    value: {
      key: "Activate hardware wallet",
      value: "Activate hardware devices",
    },
  },
  {
    type: "pair",
    value: {
      key: "Each use requires a PIN code to gain access to the hardware wallet",
      value:
        "Each use requires a PIN code to gain access to the hardware device.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Wallet activation successful",
      value: "Successful account activation",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "Your hardware wallet has been successfully activated and we have nothing to remind you of. In a word, please take good care of it. No one can help you get it back. I wish you play in the chain of blocks in the world happy",
      value:
        "Your hardware device has been successfully activated." +
        "There is nothing more we can remind you of." +
        "Anyway, remember to keep it safe." +
        " No one can help you get it back if you lose it." +
        "Have fun in the world of blockchain ❤️.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "You have successfully restored the HD Wallet on this device. We believe that you are already familiar with backing up and keeping mnemonics, so we do not require you to repeat the backup of your existing mnemonic",
      value:
        "You have already successfully restored your main wallet on this device, and we trust you are already familiar with backing up and keeping your helper words, so we won't ask you to back up your existing helper words again",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The wallet has not been backed up. For the safety of your funds, please complete the backup before using this address to initiate the collection",
      value:
        "This account has not been backed up. For the safety of your funds, please complete the backup before initiating payments using this address.",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The wallet has not been backed up. For the safety of your funds, please complete the backup before initiating the transfer using this address",
      value:
        "This account has not been backed up. For the safety of your funds, please complete the backup before initiating a transfer using this address.",
    },
  },
  {
    type: "pair",
    value: {
      key: "More child wallets are derived from mnemonics",
      value: "Derivation of more sub-accounts through helper words",
    },
  },
  {
    type: "pair",
    value: {
      key: "easy to use",
      value: "Multi-Public Chain, Simple, Secure, Works",
    },
  },
  {
    type: "pair",
    value: { key: "HD derived wallet", value: "Main Wallet" },
  },
  {
    type: "pair",
    value: {
      key: "Derivations based on HD Root Mnemonics (recommended)",
      value: "Master Wallet Account (recommended)",
    },
  },
  {
    type: "pair",
    value: {
      key: "The HD root mnemonic is derived",
      value: "Exporting the helper words of the main wallet",
    },
  },
  {
    type: "pair",
    value: { key: "Delete all HD-derived wallets", value: "Erase main wallet" },
  },
  { type: "pair", value: { key: "The signature", value: "Signature" } },
  { type: "pair", value: { key: "trading", value: "Trading" } },
  { type: "pair", value: { key: "The message", value: "Message" } },
  {
    type: "pair",
    value: {
      key: "Enter the transaction message",
      value: "Input transaction message",
    },
  },
  {
    type: "pair",
    value: {
      key: "Enter the message to be signed",
      value: "Enter the message to be signed",
    },
  },
  {
    type: "pair",
    value: { key: "Verify the signature", value: "Verify signature" },
  },
  {
    type: "pair",
    value: {
      key: "Enter the original message",
      value: "Enter the original message",
    },
  },
  {
    type: "pair",
    value: { key: "Enter the public key", value: "Enter the public key" },
  },
  {
    type: "pair",
    value: {
      key: "Enter the signed post message",
      value: "Enter the post-signature message",
    },
  },
  {
    type: "pair",
    value: { key: "The original message", value: "Original information" },
  },
  { type: "pair", value: { key: "The public key", value: "Public Key" } },
  {
    type: "pair",
    value: { key: "Post signed message", value: "Post-signature message" },
  },
  { type: "pair", value: { key: "validation", value: "Validation" } },
  {
    type: "pair",
    value: { key: "Verification by", value: "Verification passed" },
  },
  {
    type: "pair",
    value: { key: "Validation fails", value: "Verification Failure" },
  },
  {
    type: "pair",
    value: {
      key:
        "The signature information is consistent with the public key/original informatio",
      value:
        "Signature information is consistent with the public key/original information",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The signature information does not match the public key/original information",
      value:
        "Signature information does not match the public key/original information",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "This action will delete the wallet's data stored in the App, but you can still recover from the hardware wallet that knows its mnemonic words. Are you sure you want to continue?",
      value:
        "This action will delete the data stored in the App for that account, but you can still recover it through the hardware wallet that holds its helper. Are you sure you want to continue with this operation?",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "The wallet's private key or mnemonic has been securely stored on the hardware device. If you need to export a mnemonic for your hardware wallet, please go to [My Hardware] to find your device to export.",
      value:
        "The wallet's private key or passphrase is already securely stored in the hardware device. If you need to export your hardware device's mnemonic, please go to My ➡️ Hardware ➡ All Devices to find the device you want to export.",
    },
  },
  {
    type: "pair",
    value: {
      key: "Discover a new device you can...",
      value: "🎉 Discover a new device You can...",
    },
  },
  {
    type: "pair",
    value: {
      key: "Activated as a new device",
      value: "Activation as a new device (recommended)",
    },
  },
  {
    type: "pair",
    value: {
      key: "Activate the hardware wallet",
      value: "Activate hardware devices",
    },
  },
  {
    type: "pair",
    value: {
      key: "The hardware wallet will generate 12-digit mnemonic words for you",
      value: "The hardware device will generate 12-bit mnemonics for you",
    },
  },
  {
    type: "pair",
    value: {
      key: "The hardware wallet will generate 24-digit mnemonic words for you",
      value: "The hardware device will generate 24-bit mnemonics for you",
    },
  },
  {
    type: "pair",
    value: {
      key: "Use 12-digit mnemonic words",
      value: "Use 12-bit mnemonics",
    },
  },
  {
    type: "pair",
    value: {
      key: "Use 24-digit mnemonic words",
      value: "Use 24-bit mnemonics",
    },
  },
  {
    type: "pair",
    value: {
      key:
        "It is suitable for the vast majority of first-time users of the hardware wallet",
      value: "Suitable for most first-time users of hardware devices",
    },
  },
  { type: "pair", value: { key: "12", value: "12 bits" } },
  { type: "pair", value: { key: "24", value: "24 bits" } },
  {
    type: "pair",
    value: {
      key: "Select the number of mnemonic words",
      value: "Select the number of helper words",
    },
  },
];